...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2017 at 08:11 PM
...
(2, 'dr0001', 'hannibal', 'thomas harris', 'Nha Nam', '123-345-678', 'a man and his obssesion with an other man', 10000),
...
CREATE TABLE `borrowcard` (
  ...
  `activate_code` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `borrowcard` (`card_id`, `user_id`, `expired_date`, `deposit`, `activate_code`) VALUES
(1, 3, '2018-02-06', 100000, 'csdasfasgasg'),
(2, 5, '2018-02-06', 100000, 'asfasgasgasg'),
(3, 6, '2018-02-06', 500000, 'gasfasfas');
...
(1, 1, 1, 4, '2017-12-21', '2017-12-25', '2017-09-25', 0),
(2, 5, 1, 5, '2017-10-28', NULL, NULL, 0);
...
(1, 2, 'dr0001-1', 'borrowed', 30000, 'good', 'borrowable'),
...
(7, 2, 'dr0001-2', 'available', 15000, 'good', 'borrowable'),
(8, 2, 'dr0001-4', 'available', 10000, 'good', 'reference'),
(9, 2, 'dr0001-5', 'available', 10000, 'good', 'reference');
...
(1, 0, 'admin', '1', 'admin is Khang', 'khangnl.bk@gmail.com', 21, 'earth', 1, 123, 50000),
(2, 1, 'admin2', '1', 'same Khang', 'khang@gmail.com', 21, 'hanoi', 1, 20132134, 60000),
(3, 2, '1', '1', 'abc is abc', 'example@gmail.com', 21, 'hanoi', 2, 20130000, 60000),
(5, 2, 'lam', '1', 'Tung Lam', 'abc@gmail.com', NULL, 'Ha noi', NULL, NULL, NULL),
(6, 2, 'loan', '1', 'To Loan', 'abc1@gmail.com', NULL, 'Ha Noi', NULL, NULL, NULL);
